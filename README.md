## 👋 Olá! Sou João, Desenvolvedor Backend e Entusiasta em Automação

Sou um profissional focado em desenvolvimento backend, integrações corporativas e automações inteligentes. Tenho experiência com APIs REST, manipulação de dados, sistemas ERP (especialmente SAP), dashboards em Power BI e criação de soluções que conectam diversos serviços para otimizar processos.
